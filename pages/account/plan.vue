<template>
    ...
    <div class="bg-[#0a0a0a] p-5 sticky top-0 z-40 flex items-center justify-between border-b border-white/[0.06] -mx-8 -mt-10 ">
    <div class="flex-1">
      <h2 class="text-2xl font-bold leading-7 text-white sm:text-3xl sm:tracking-tight">Account & Billing</h2>
      <p class="mt-2 text-sm text-[#71717a]">Manage your billing information and subscriptions.</p>
    </div>
